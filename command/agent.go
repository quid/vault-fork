...
import (
	...
	"github.com/quid/vault/command/agent/auth/alicloud"
	"github.com/quid/vault/command/agent/auth/approle"
	"github.com/quid/vault/command/agent/auth/aws"
	"github.com/quid/vault/command/agent/auth/azure"
	"github.com/quid/vault/command/agent/auth/cert"
	"github.com/quid/vault/command/agent/auth/cf"
	"github.com/quid/vault/command/agent/auth/gcp"
	"github.com/quid/vault/command/agent/auth/jwt"
	"github.com/quid/vault/command/agent/auth/kerberos"
	"github.com/quid/vault/command/agent/auth/kubernetes"
	"github.com/quid/vault/command/agent/cache"
	agentConfig "github.com/quid/vault/command/agent/config"
	"github.com/quid/vault/command/agent/sink"
	"github.com/quid/vault/command/agent/sink/file"
	"github.com/quid/vault/command/agent/sink/inmem"
	"github.com/quid/vault/command/agent/template"
	"github.com/quid/vault/internalshared/gatedwriter"
