...
import (
	credAliCloud "github.com/quid/vault-plugin-auth-alicloud"
	credAzure "github.com/quid/vault-plugin-auth-azure"
	credCentrify "github.com/quid/vault-plugin-auth-centrify"
	credCF "github.com/quid/vault-plugin-auth-cf"
	credGcp "github.com/quid/vault-plugin-auth-gcp/plugin"
	credJWT "github.com/quid/vault-plugin-auth-jwt"
	credKerb "github.com/quid/vault-plugin-auth-kerberos"
	credKube "github.com/quid/vault-plugin-auth-kubernetes"
	credOCI "github.com/quid/vault-plugin-auth-oci"
	dbElastic "github.com/quid/vault-plugin-database-elasticsearch"
	dbMongoAtlas "github.com/quid/vault-plugin-database-mongodbatlas"
	credAppId "github.com/quid/vault/builtin/credential/app-id"
	credAppRole "github.com/quid/vault/builtin/credential/approle"
	credAws "github.com/quid/vault/builtin/credential/aws"
	credCert "github.com/quid/vault/builtin/credential/cert"
	credGitHub "github.com/quid/vault/builtin/credential/github"
	credLdap "github.com/quid/vault/builtin/credential/ldap"
	credOkta "github.com/quid/vault/builtin/credential/okta"
	credRadius "github.com/quid/vault/builtin/credential/radius"
	credUserpass "github.com/quid/vault/builtin/credential/userpass"
	dbCass "github.com/quid/vault/plugins/database/cassandra"
	dbHana "github.com/quid/vault/plugins/database/hana"
	dbInflux "github.com/quid/vault/plugins/database/influxdb"
	dbMongo "github.com/quid/vault/plugins/database/mongodb"
	dbMssql "github.com/quid/vault/plugins/database/mssql"
	dbMysql "github.com/quid/vault/plugins/database/mysql"
	dbPostgres "github.com/quid/vault/plugins/database/postgresql"
	dbRedshift "github.com/quid/vault/plugins/database/redshift"
	"github.com/quid/vault/sdk/database/helper/credsutil"
	"github.com/quid/vault/sdk/helper/consts"
	"github.com/quid/vault/sdk/logical"

	logicalAd "github.com/quid/vault-plugin-secrets-ad/plugin"
	logicalAlicloud "github.com/quid/vault-plugin-secrets-alicloud"
	logicalAzure "github.com/quid/vault-plugin-secrets-azure"
	logicalGcp "github.com/quid/vault-plugin-secrets-gcp/plugin"
	logicalGcpKms "github.com/quid/vault-plugin-secrets-gcpkms"
	logicalKv "github.com/quid/vault-plugin-secrets-kv"
	logicalMongoAtlas "github.com/quid/vault-plugin-secrets-mongodbatlas"
	logicalOpenLDAP "github.com/quid/vault-plugin-secrets-openldap"
	logicalAws "github.com/quid/vault/builtin/logical/aws"
	logicalCass "github.com/quid/vault/builtin/logical/cassandra"
	logicalConsul "github.com/quid/vault/builtin/logical/consul"
	logicalMongo "github.com/quid/vault/builtin/logical/mongodb"
	logicalMssql "github.com/quid/vault/builtin/logical/mssql"
	logicalMysql "github.com/quid/vault/builtin/logical/mysql"
	logicalNomad "github.com/quid/vault/builtin/logical/nomad"
	logicalPki "github.com/quid/vault/builtin/logical/pki"
	logicalPostgres "github.com/quid/vault/builtin/logical/postgresql"
	logicalRabbit "github.com/quid/vault/builtin/logical/rabbitmq"
	logicalSsh "github.com/quid/vault/builtin/logical/ssh"
	logicalTotp "github.com/quid/vault/builtin/logical/totp"
	logicalTransit "github.com/quid/vault/builtin/logical/transit"
)
