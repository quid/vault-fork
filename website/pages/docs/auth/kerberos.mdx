...
- [The plugin's code](https://github.com/quid/vault-plugin-auth-kerberos)
...
These commands run variations of [a script](https://github.com/quid/vault-plugin-auth-kerberos/blob/master/scripts/integration_env.sh)
