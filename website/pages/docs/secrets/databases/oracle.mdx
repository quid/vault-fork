...
[hashicorp/vault-plugin-database-oracle](https://github.com/quid/vault-plugin-database-oracle)
...
at its own git repository here: [hashicorp/vault-plugin-database-oracle](https://github.com/quid/vault-plugin-database-oracle)
