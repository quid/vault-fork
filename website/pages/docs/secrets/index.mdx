...
of their function. Secrets engines operate by receiving API calls that meet [this interface](https://github.com/quid/vault/blob/061bc8ed2bbed49eb4f54c3a04647fbbefb13e48/sdk/framework/backend.go#L105). The calls receive data from the caller, take some
