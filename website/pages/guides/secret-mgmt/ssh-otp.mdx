...
- [Vault SSH Helper](https://github.com/quid/vault-ssh-helper)
...
Helper](https://github.com/quid/vault-ssh-helper) to verify the OTP used
...
1.  Create a Vault SSH Helper configuration file,
    ...
    **Example:**
    ...
    > Refer to the [documentation](https://github.com/quid/vault-ssh-helper#vault-ssh-helper-configuration)
...
1.  Modify the **`/etc/pam.d/sshd`** file as follows:
    ...
    **NOTE:** `common-auth` is the standard Linux authentication module which is
    ...
    > Refer to the
    > [documentation](https://github.com/quid/vault-ssh-helper#pam-configuration)
