...
[`logical/plugin/mock`](https://github.com/quid/vault/tree/master/logical/plugin/mock/mock-plugin) package.

Download the source (you would probably use your own plugin):

```shell-session
$ go get -f -u -d github.com/quid/vault
# ...
$ cd $GOPATH/src/github.com/quid/vault/sdk/plugin/mock/mock-plugin
```
...
```shell-session
$ cd $GOPATH/src/github.com/quid/vault/builtin/credential/approle/cmd/approle
$ go build
