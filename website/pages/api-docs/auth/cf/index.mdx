...
build the signature, its signing algorithm is viewable [here](https://github.com/quid/vault-plugin-auth-cf/tree/master/signatures).
The [plugin repo](https://github.com/quid/vault-plugin-auth-cf) also contains
