...
- The [vault-ssh-helper](https://github.com/quid/vault-ssh-helper) can be used to enable one-time passwords for SSH authentication via Vault
...
Want to add your own project, or one that you use? Additions are welcome via [pull requests](https://github.com/quid/vault/blob/master/website/pages/api-docs/relatedtools.mdx).
