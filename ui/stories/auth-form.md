...
- [Uses of AuthForm](https://github.com/quid/vault/search?l=Handlebars&q=AuthForm)
- [AuthForm Source Code](https://github.com/quid/vault/blob/master/ui/app/components/auth-form.js)
