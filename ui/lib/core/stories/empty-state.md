...
- [Uses of EmptyState](https://github.com/quid/vault/search?l=Handlebars&q=EmptyState+OR+empty-state)
- [EmptyState Source Code](https://github.com/quid/vault/blob/master/ui/lib/core/addon/components/empty-state.js)
